...
const BookingSteps = () => {
  const steps = [
    ...
    },
    {
      ...
      description:
        "Next, we will share you handful of Hyderabad Escorts girls images. Handpick your favorite call girl starting at INR 15K/Shot.",
    },
    {
      icon: <FaLocationArrow className="w-8 h-8 mb-4" />,
      title: "3. SHARE LOCATION",
      description:
        "Thirdly, you need to share your live location so that we can forward our call girl Hyderabad at your staycation in hotel or house.",
    },
    {
      icon: <FaSmile className="w-8 h-8 mb-4" />,
      title: "4. BOOM! ENJOY!",
      description:
        "You are all set! Now just wait for approx. 50 minutes and expect to see a gorgeous escort in Hyderabad at your place.",
    },
  ];
    ...
    <section className="py-16 px-4 bg-black">
      <div className="max-w-6xl mx-auto">
        <motion.h2
          ...
          viewport={{ once: true }}
        >
          How To Book Our Escorts in Hyderabad
        </motion.h2>
